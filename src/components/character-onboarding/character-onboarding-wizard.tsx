...
export function CharacterOnboardingWizard({
  ...
  return (
    ...
    >
      <DialogContent
        className="grid h-full w-full grid-cols-1 grid-rows-[auto_1fr_auto] gap-0 overflow-hidden p-0 sm:h-auto sm:max-h-[90vh] sm:max-w-[95vw] md:grid-cols-[1fr_auto] lg:max-w-[1400px]"
