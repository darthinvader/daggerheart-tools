...
import {
  NAV_CONTENT_MOTION_CLASSES,
  NAV_CONTENT_VIEWPORT_FALSE_CLASSES,
...
const navigationMenuTriggerStyleFn = cva(
...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(navigationMenuTriggerStyleFn(), 'group', className)}
      {...props}
    >
      {children}{' '}
      <ChevronDownIcon
...
// Note: navigationMenuTriggerStyle is intentionally not exported to satisfy
// react-refresh rule (only export components from component files).
