...
export const ApiEquipmentSchema = z.object({
  primaryWeapon: z.unknown().optional().nullable(),
  primaryWeaponMode: z.enum(['standard', 'homebrew', 'custom']).optional(),
  homebrewPrimaryWeapon: z.unknown().optional(),
  customPrimaryWeapon: z.unknown().optional(),
  secondaryWeapon: z.unknown().optional().nullable(),
  secondaryWeaponMode: z.enum(['standard', 'homebrew', 'custom']).optional(),
  homebrewSecondaryWeapon: z.unknown().optional(),
  customSecondaryWeapon: z.unknown().optional(),
  armor: z.unknown().optional().nullable(),
  armorMode: z.enum(['standard', 'homebrew', 'custom']).optional(),
  homebrewArmor: z.unknown().optional(),
  customArmor: z.unknown().optional(),
  useCombatWheelchair: z.boolean().optional(),
  combatWheelchair: z.unknown().optional().nullable(),
  wheelchairMode: z.enum(['standard', 'homebrew', 'custom']).optional(),
  homebrewWheelchair: z.unknown().optional(),
  customWheelchair: z.unknown().optional(),
  customSlots: z.array(z.unknown()).optional(),
  items: z.array(z.unknown()).default([]),
  consumables: z.record(z.string(), z.unknown()).default({}),
});
