...
export const DIFFICULTY_LEVELS: DifficultyLevel[] = [
  {
    ...
    examples: [
      ...
      'Sprint within Close range across an open field with an enemy present (Agility)',
  ...
  },
  {
    ...
    examples: [
      ...
      'Sprint within Far range across an open field with an enemy present (Agility)',
  ...
  },
  {
    ...
    examples: [
      ...
      "Sense a shred of doubt within a god's pronouncement (Instinct)",
      'Sprint across the heads of your enemies in a pitched battle (Agility)',
