...
export const inspiringSacrifice: DeathMove = {
  ...
  description:
    'In your final moments, you inspire your allies with a rousing speech',
...
export const elaraTheBard: PlayerCharacter = {
  ...
  pronouns: 'she/her',
  description:
    'A charismatic half-elf bard with silver hair and eyes like starlight, carrying an ornate lute and dressed in traveling clothes adorned with small bells.',
  ...
  background: {
    notes:
      'Elara was born to an elven mother and human father in a traveling caravan. She learned music and storytelling from the diverse cultures she encountered.',
    questions: [
      {
      ...
      },
      {
        ...
        answer:
          'An old human bard named Marcus, who showed me that stories can heal or harm',
      },
    ],
  ...
  connections: [
    {
      ...
      description:
        "Met when Elara talked us out of a bar fight. He's surprisingly gentle for a warrior.",
      strength: 'strong',
      type: 'friendly',
    ...
    },
    {
      ...
      description:
        'Fellow performer, but they compete for attention. Complicated relationship.',
      strength: 'moderate',
      type: 'rival',
